...
import lectAction from "@/app/lecturers/[uuid]/lectAction"
                        ...
                        <div className="flex flex-col gap-4 py-4">
                            ...
                            <form
                                ...
                                onSubmit={form.handleSubmit(async (formData) => {
                                    const res = await lectAction(formData);
                                    if (res === true) setIsOpen(false); setFormError(false);
                                    setIsOpen(true)
                                    setFormError(true)
                                })}
                            >
                                    ...
                                    />
                                    {formError && <p className="text-red-800">Vyplňte všechny políčka!</p>}
